...
var ubiveloxSKT = 'http://hybridstg2.sktsmarthome.com:30000/skt';
/** 2.1.1 intro
 * POST /cmm/init
 *
 * * header
 ...
 * * Request Attributes
 * hid // 가전아이디
 * searchDateType // 날짜검색 타입(10:일, 20:주, 30:월, 40:년)
 * sesrchDate // 날짜 검색타입이 10인경우 필수(해당 일 YYYYMMDD)
 * searchStartDate // 날짜 검색타입이 10이 아닌경우 필수( 검색 날짜 시작일 YYYYMMDD)
 * searchEndDate // 날짜 검색타입이 10이 아닌경우 필수( 검색 날짜 마지막일 YYYYMMDD)
 *
 **/

directory.airReport = Backbone.Model.extend({
    url: ubiveloxSKT + '/stats/insReport'
});

App.model.airReport = new directory.airReport;
