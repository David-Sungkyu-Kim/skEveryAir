...
Handlebars.registerHelper("dvcNickNm", function (data) {
...
Handlebars.registerHelper("winixDeviceCheck", function (data,options) {
    if (data === "DVC0000203" || data === "DVC0000173" || data === "DVC0000186") {
        return options.fn(this);
    } else {
        return options.inverse(this);
    }
...
Handlebars.registerHelper("sensorFncValCheck", function (fncVal , connStatYn) {
...
Handlebars.registerHelper("isOutFncInfo", function (connStatYn) {
